...
unnecessary = c(
  ...
  "UF_ENTIDADE_CERTIFICACAO", "COD_MUNICIPIO_PROVA", "NO_MUNICIPIO_PROVA", "UF_MUNICIPIO_PROVA", "IN_PRESENCA_CN",
  "IN_PRESENCA_CH", "IN_PRESENCA_LC", "IN_PRESENCA_MT", "TX_RESPOSTAS_CN", "TX_RESPOSTAS_CH", "TX_RESPOSTAS_LC", "TX_RESPOSTAS_MT",
